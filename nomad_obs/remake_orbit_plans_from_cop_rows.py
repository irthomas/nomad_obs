...
for obs_name in obs_names:
    try:
        outputDict, diffractionOrders, integrationTime, rhythm, windowHeight, channelCode = getCopRows(obs_name, nadirObservationDict, copTableDict, copTableCombinationDict, centreDetectorLines, silent=True)
...
for obs_name in obs_names:
    try:
        outputDict, diffractionOrders, integrationTime, rhythm, windowHeight, channelCode = getCopRows(obs_name, occultationObservationDict, copTableDict, copTableCombinationDict, centreDetectorLines, silent=True)
        subd_cop_row = outputDict["scienceCopRow"]
