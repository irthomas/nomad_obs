...
#        ALLOCATED_DATA_VOLUME = #MBits # add if required
        ...
        copVersion = "20231028_120000" #desired cop table folder - remember to update if patched
        forbidden_dayside_orbits = [8, 9, 48, 66, 72, 73, 85, 86, 109, 110, 131, 143, 161, 171, 174, 175, 178, 179, 188, 206, 256, 257, 279, 280, 287, 288, 318, 319, 337] #input these from the email
...
#        ALLOCATED_DATA_VOLUME = #MBits # add if required
        ...
        copVersion = "20231028_120000" #desired cop table folder - remember to update if patched
        forbidden_dayside_orbits = [6, 7, 31, 32, 46, 47, 51, 52, 55, 56, 85, 86, 107, 108, 138, 139, 144, 145, 162, 163, 169, 170, 171, 179, 180, 185, 186, 200, 201, 231, 232, 249, 250, 256, 257, 288, 289, 294, 295, 305, 306, 319, 320] #input these from the email
        required_dayside_orbits = [] #add if LNO needs to operate on certain orbits e.g. joint observations
        occultation_precooling = 440 #seconds required for precooling
#        ALLOCATED_DATA_VOLUME = #MBits # add if required
        ...
        copVersion = "20231028_120000" #desired cop table folder - remember to update if patched
        forbidden_dayside_orbits = [85, 86, 121, 139, 150, 151, 162, 166, 171, 175, 176, 179, 180, 184, 185, 189, 194, 195, 256, 257, 325, 326, 330, 332, 333, 338, 339] #input these from the email
...
#        ALLOCATED_DATA_VOLUME = #MBits # add if required
        ...
        copVersion = "20231028_120000" #desired cop table folder - remember to update if patched
        forbidden_dayside_orbits = [6, 23, 45, 57, 75, 85, 86, 99, 100, 111, 118, 119, 169, 170, 171, 173, 174, 188, 225, 231, 232, 243, 244, 249, 256, 257, 262, 301, 302, 305, 306, 336, 337] #input these from the email
