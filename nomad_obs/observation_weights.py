...
NADIR_WEIGHTS = [
    ...
    ["H2O CO 3SUBD #2"] * 32, #H #168, 189, 190
    ["Ice CO 2SUBD #2"] * 32, #H #193, 189
    ...
    ["Surface Ice 3SUBD #2"] * 8, #H #189, 132, 133
    ["Surface Ice 3SUBD #3"] * 8, #H #193, 132, 133
    ...
    # ["HDO H2O 2SUBD 03"] * 2, #L #121, 168
    # ["HDO H2O 2SUBD 02"] * 2, #L #168, 124
