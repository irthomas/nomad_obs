...
#    h += r"<h2>SO/LNO Observation Plan</h2>"+"\n"
    ...
    headers = ["Name", "Diffraction Order 1", "Diffraction Order 2", "Diffraction Order 3", "Diffraction Order 4",
               "Diffraction Order 5", "Diffraction Order 6", "Integration Time", "Rhythm", "Detector Height"]
    h += r"<table border=1>"+"\n"
    h += r"<tr>"+"\n"
